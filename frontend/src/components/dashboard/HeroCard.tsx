...
export default function HeroCard({ stats }: HeroCardProps) {
  ...
  return (
    <div className="rounded-xl p-6 bg-white border border-(--accent)">
      {/* Montant restant — chiffre roi */}
      <p className="text-black/60 text-sm font-medium mb-1">Restant ce mois</p>
      <p
        ...
        style={{
          ...
          color: isNegative ? 'var(--error)' : 'black',
        }}
      >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <p className="text-black/50 text-xs font-medium uppercase tracking-wider mb-0.5">
            Revenus
          </p>
          <p
        ...
        <div>
          ...
          <p
            className="font-semibold text-lg text-red-400"
            style={{ fontFamily: 'var(--font-mono)' }}
          >
