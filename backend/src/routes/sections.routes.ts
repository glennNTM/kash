...
import { createSectionSchema, updateSectionSchema, updatePercentagesSchema } from '../validators/sections.schema.js'
import { getByMonth, getById, create, update, updatePercentages, remove } from '../controllers/sections.controller.js'
...
sectionsRouter.put('/month/:monthId/percentages', requireAuth, validate(updatePercentagesSchema), updatePercentages)
